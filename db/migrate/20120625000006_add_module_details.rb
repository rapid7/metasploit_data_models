# Add module_details tree.
class AddModuleDetails < ActiveRecord::Migration
  # Drops module_actions, module_archs, module_authors, module_details, module_mixins, module_platforms, module_refs,
  # and module_targets.
  #
  # @return [void]
  def down
  ...
  # Creates module_actions, module_archs, module_authors, module_details, module_mixins, module_platforms, module_refs,
  # and module_targets.
  #
  # @return [void]
  def up
