# Creates attachments, attachments_email_templates, campaigns, email_templates, and web_templates.
class AddCampaignsAndTemplates < ActiveRecord::Migration
  # Drops attachments, attachments_email_templates, campaigns, email_templates, and web_templates.
  #
  # @return [void]
  def down
