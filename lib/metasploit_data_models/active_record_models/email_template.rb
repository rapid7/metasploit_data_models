module MetasploitDataModels::ActiveRecordModels::EmailTemplate
  def self.included(base)
    base.class_eval {
      ...
      has_and_belongs_to_many :attachments, :uniq => true, :class_name => "Mdm::Attachment"
      belongs_to :email_template, :foreign_key => :parent_id, :class_name => "Mdm::EmailTemplate"
      has_one :email_template, :foreign_key => :parent_id, :class_name => "Mdm::EmailTemplate"
