...
--
-- Name: creds_depricated; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE creds_depricated (
    id integer NOT NULL,
...
--
-- Name: creds_depricated_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE creds_depricated_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: creds_depricated_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE creds_depricated_id_seq OWNED BY creds_depricated.id;
...
ALTER TABLE ONLY creds_depricated ALTER COLUMN id SET DEFAULT nextval('creds_depricated_id_seq'::regclass);
...
--
-- Name: creds_depricated_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY creds_depricated
    ADD CONSTRAINT creds_depricated_pkey PRIMARY KEY (id);
